...
--   2. Extensions
--   3. ENUM types
--   4. CHECK constraints dengan regex / array literal
--   5. Views
-- =============================================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS vw_rule_merchant_dim_keyword_code_idx
  ON public.vw_rule_merchant_dim USING btree (keyword_code);
