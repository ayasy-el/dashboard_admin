...
ALTER TABLE "merchant_feedback" ADD CONSTRAINT "merchant_feedback_user_id_user_accounts_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
